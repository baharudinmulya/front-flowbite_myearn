        ...
        <div className="mb-1 w-full">
          ...
          <div className="block items-center sm:flex">
            ...
            <div className="flex w-full items-center sm:justify-end">
              <AddProductModal onAddTransaksi={handleTableRefresh} brands={brands} setBrands={setBrands} akun={akun} setAkun={setAkun}/>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <Table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
      <Table.Head className="bg-gray-100 dark:bg-gray-700">
        ...
        <Table.HeadCell>Akun</Table.HeadCell>
      ...
      {transaksi_.map((transaksi) => (
        ...
        >
          ...
          <Table.Cell className="whitespace-nowrap p-4 text-base font-medium text-gray-900 dark:text-white">
            {transaksi.nama_akun === "Pemasukan" ? (
              <span style={{ backgroundColor: "green" }}>{transaksi.nama_akun}</span>
            ) : transaksi.nama_akun === "Pengeluaran" ? (
              <span style={{ backgroundColor: "red" }}>{transaksi.nama_akun}</span>
            ) : (
              transaksi.nama_akun
            )}
          </Table.Cell>
          ...
          <Table.Cell className="space-x-2 whitespace-nowrap p-4">
            <div className="flex items-center gap-x-3">
              <EditProductModal rowData={transaksi} brands={brands} setBrands={setBrands} onAddTransaksi={handleTableRefresh} />
              <DeleteProductModal />
            </div>
          </Table.Cell>
        </Table.Row>
